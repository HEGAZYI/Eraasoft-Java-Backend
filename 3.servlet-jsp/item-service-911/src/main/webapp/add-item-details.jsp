...
%>
	<div class="container">
		...
		<form action="<%= request.getContextPath() %>/ItemController"
			method="post">
			<input type="hidden" name="action" value="addDetails"> <input
			...
			<div class="form-row">
				<label>Category</label> <input type="text" name="category"
					maxlength="100" placeholder="e.g. Electronics">
			</div>
			<div class="form-row">
				<label>Manufacturer</label> <input type="text" name="manufacturer"
					maxlength="100" placeholder="e.g. Acme Corp">
			</div>
			<div class="form-row">
				<label>Warranty (months)</label> <input type="number"
					name="warrantyMonths" min="0" value="0">
			</div>
